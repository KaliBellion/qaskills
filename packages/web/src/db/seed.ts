...
async function seed() {
  ...
  const seedSkills = [
    ...
    { name: 'Vibe Check - Browser Automation', slug: 'vibe-check', description: 'Automate Chrome browser interactions via CLI with persistent daemon mode. Navigate pages, extract content, click elements, type text, manage tabs, and take screenshots.', authorName: 'vibiumdev', qualityScore: 88, installCount: 1580, weeklyInstalls: 22, testingTypes: ['e2e', 'visual'], frameworks: ['playwright'], languages: ['typescript', 'javascript'], domains: ['web'], agents: ['claude-code', 'cursor', 'github-copilot', 'opencode', 'gemini-cli', 'codex', 'amp'], featured: true, verified: true, githubUrl: 'https://github.com/vibiumdev/vibium' },
    { name: 'Agent Browser', slug: 'agent-browser', description: 'Browser automation tool by Vercel Labs enabling programmatic web interaction. Navigate URLs, capture interactive elements with refs, fill forms, take screenshots, generate PDFs, and run parallel sessions.', authorName: 'vercel-labs', qualityScore: 95, installCount: 29800, weeklyInstalls: 29800, testingTypes: ['e2e', 'visual', 'accessibility'], frameworks: ['playwright'], languages: ['typescript', 'javascript'], domains: ['web', 'mobile'], agents: ['claude-code', 'cursor', 'github-copilot', 'opencode', 'gemini-cli', 'codex', 'amp', 'windsurf', 'aider', 'continue', 'cline', 'zed', 'bolt'], featured: true, verified: true, githubUrl: 'https://github.com/vercel-labs/agent-browser' },
  ];
