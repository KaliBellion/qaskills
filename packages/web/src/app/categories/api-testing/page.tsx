    ...
    <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
      ...
      <div className="mb-8">
        <nav className="mb-4 text-sm text-muted-foreground">
          ...
          <span className="mx-2">/</span>
          <span className="text-foreground">API Testing</span>
        </nav>
        <h1 className="text-3xl font-bold tracking-tight sm:text-4xl">
          API Testing Skills for AI Agents
        </h1>
        <p className="mt-3 max-w-3xl text-lg text-muted-foreground">
          API testing skills for AI coding agents. REST, GraphQL, and HTTP testing automation —
          install expert skills in seconds.
        </p>
      ...
      {/* What is API testing section */}
      <div className="mb-8 rounded-lg bg-muted/50 p-6">
        <h2 className="mb-2 text-lg font-semibold">What is API Testing?</h2>
        <p className="text-sm text-muted-foreground">
          API testing validates the business logic, data integrity, and reliability of application
          programming interfaces without relying on a user interface. It covers REST APIs, GraphQL
          endpoints, gRPC services, and WebSocket connections. API tests are faster and more stable
          than UI tests, making them ideal for continuous integration pipelines. These skills
          equip your AI agent with expertise in request/response validation, authentication
          testing, JSON schema verification, error handling scenarios, and API contract testing
          using tools like Playwright, Postman, REST Assured, and Pact.
        </p>
      </div>
      ...
      {categorySkills.length === 0 && (
        <div className="py-16 text-center">
          <p className="text-lg font-medium">No API testing skills found</p>
