...
export const metadata: Metadata = {
  ...
  openGraph: {
    ...
    description:
      'Unit testing skills for AI coding agents. Jest, Vitest, pytest, and more — curated testing expertise for your AI pair programmer.',
    url: 'https://qaskills.sh/categories/unit-testing',
    type: 'website',
  },
};

export default async function UnitTestingPage() {
  const categorySkills = await db
    .select()
    .from(skills)
    .where(sql`${skills.testingTypes} @> '["unit"]'::jsonb`)
    .orderBy(desc(skills.installCount));

  const breadcrumbJsonLd = generateBreadcrumbJsonLd([
    { name: 'Home', url: 'https://qaskills.sh' },
    { name: 'Categories', url: 'https://qaskills.sh/categories' },
    { name: 'Unit Testing', url: 'https://qaskills.sh/categories/unit-testing' },
  ]);
    ...
    <div className="mx-auto max-w-7xl px-4 py-8 sm:px-6 lg:px-8">
      <script
        ...
        dangerouslySetInnerHTML={{
          __html: JSON.stringify({
            ...
            '@type': 'CollectionPage',
            name: 'Unit Testing Skills for AI Agents',
            description:
              'Unit testing skills for AI coding agents. Jest, Vitest, pytest, and more — curated testing expertise for your AI pair programmer.',
            url: 'https://qaskills.sh/categories/unit-testing',
            mainEntity: {
      ...
      <div className="mb-8">
        <nav className="mb-4 text-sm text-muted-foreground">
          ...
          <span className="mx-2">/</span>
          <span className="text-foreground">Unit Testing</span>
        </nav>
        <h1 className="text-3xl font-bold tracking-tight sm:text-4xl">
          Unit Testing Skills for AI Agents
        </h1>
        <p className="mt-3 max-w-3xl text-lg text-muted-foreground">
          Unit testing skills for AI coding agents. Jest, Vitest, pytest, and more — curated
          testing expertise for your AI pair programmer.
        </p>
      ...
      {/* What is unit testing section */}
      <div className="mb-8 rounded-lg bg-muted/50 p-6">
        <h2 className="mb-2 text-lg font-semibold">What is Unit Testing?</h2>
        <p className="text-sm text-muted-foreground">
          Unit testing verifies that individual functions, methods, and components work correctly in
          isolation. By testing the smallest units of code independently, developers catch bugs
          early in the development cycle before they compound into larger issues. Modern unit
          testing frameworks like Jest, Vitest, and pytest provide powerful features including
          mocking, spying, snapshot testing, and code coverage analysis. These skills teach your AI
          agent proven patterns for writing fast, deterministic unit tests with proper test
          isolation, assertion strategies, and mock management.
        </p>
      </div>
      ...
      {categorySkills.length === 0 && (
        <div className="py-16 text-center">
          <p className="text-lg font-medium">No unit testing skills found</p>
